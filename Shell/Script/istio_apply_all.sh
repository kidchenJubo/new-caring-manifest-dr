...
gcloud config set project "jubo-care-platform"

gcloud auth application-default set-quota-project "jubo-care-platform"

gcloud container clusters get-credentials jcp-tw --region=asia-east1
