...
```shell
gcloud container clusters delete "caring-release" --location "asia-east1" --async
```
...
```shell
helm upgrade --force --install -f ./Infrastructure/istio/values_release.yaml istio ./Infrastructure/istio -n istio-system --create-namespace --set defaultRevision=default
```

### Upgrade Istio
```shell
helm upgrade --force -f ./Infrastructure/istio/values_release.yaml istio ./Infrastructure/istio -n istio-system --create-namespace --set defaultRevision=default
```
...
```shell
helm upgrade --force --install -f ./Infrastructure/argocd/values_release.yaml argocd ./Infrastructure/argocd --create-namespace -n argocd
```

### Upgrade ArgoCD
```shell
helm upgrade --force -f ./Infrastructure/argocd/values_release.yaml argocd ./Infrastructure/argocd --create-namespace -n argocd
```
