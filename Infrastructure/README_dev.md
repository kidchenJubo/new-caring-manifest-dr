...
```shell
gcloud container clusters delete "new-caring-dev" --location "asia-east1" --async
```
...
```shell
gcloud container clusters get-credentials new-caring-dev --region=asia-east1
```
